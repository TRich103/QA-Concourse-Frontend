...
class PrivNotice extends Component {
    ...
    componentDidMount(){
        axios.get('https://' + process.env.REACT_APP_BACKEND_IP + '/privacy/' + this.state.currentUser.token._id)
        .then(response => {
            ...
            <div data-keyboard="false">
                ...
                <Button
                    ...
                    onClick = {() => {
                        ...
                        axios.get('https://'+process.env.REACT_APP_AWS_IP+'/privacy/accept/'+this.state.currentUser.token._id).then(() => this.setState({ showModal: false })) } }
